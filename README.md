...
## API 簡介
為了提供即時且精準的分析數據，以協助醫療院所與患者溝通，我們開發了醫療精準關懷服務系統，並將此系統內的 API 架構開放出來，希望能透過這份醫療 CRM API 規格文件，讓醫療體系與第三方協力廠商，能夠共同合作，連結成一個醫病溝通大數據平台，以加速台灣醫病溝通理念的進展，同時也讓台灣醫療環境能夠向雲端與數據化服務的新時代邁進。
